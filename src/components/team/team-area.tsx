...
>
  ...
  style={{
    ...
    flexShrink: 0,
    borderRadius: "8px",
    background: "url(assets/img/about/about/p1.png) lightgray 50% / cover no-repeat",
    position: "relative",
    marginBottom: "8px",
    overflow: "hidden"
  }}
>
  ...
  style={{
    ...
    flexShrink: 0,
    borderRadius: "8px",
    background: "url(assets/img/about/about/p3.png) lightgray 50% / cover no-repeat",
    position: "relative",
    marginBottom: "8px",
    overflow: "hidden"
  }}
>
  ...
  style={{
    ...
    flexShrink: 0,
    borderRadius: "8px",
    background: "url(assets/img/about/about/p4.png) lightgray 50% / cover no-repeat",
    position: "relative",
    marginBottom: "8px",
    overflow: "hidden"
  }}
>
  ...
  style={{
    ...
    flexShrink: 0,
    borderRadius: "8px",
    background: "url(assets/img/about/about/p5.png) lightgray 50% / cover no-repeat",
    position: "relative",
    marginBottom: "8px",
    overflow: "hidden"
  }}
