...
const HeroAreaTwo = () => {
  return (
    ...
    <section className="hero-section position-relative">
      ...
      <div
        className="container custom-container-larg position-relative z-index-2 text-center"
      ...
      >
        ...
        <div className="content-container">
          <h1
            ...
            style={{ color: "#000A06", width: "698px" }}
          >
            <strong>Learn. Transform . Lead</strong>
          </h1>

          <p className="paragraph">
            DTMA equips professionals and organizations with AI-driven,
          ...
          <Image
            src="/assets/img/hero/Message.svg"
            width={80}
            height={80}
            alt="message"
