...
export default function CourseListItemTwo({
  course,
  sm_title,
  title_cls,
}: IProps) {
    ...
    <div className="tp-course-filter-item mb-25 d-flex">
      ...
      <div className="tp-course-filter-content">
        ...
        <h4 className={title_cls ? title_cls : "tp-course-titles"}>
          <Link href={`/course-details/${id}`}>
            {sm_title
              ? removeTagInText(title).slice(0, 28) + "..."
        ...
        <div className="tp-course-filter-p">
          <p>
            In this course, We will learn how to create websites by structuring
            and styling your pages with HTML and CSS.
          </p>
        </div>
