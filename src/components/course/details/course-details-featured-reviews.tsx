...
const reviewsData = [
  {
    ...
    timeAgo: "2 weeks ago",
    content:
      "I love the way the instructor goes about the course. So easy to follow, even though a little bit challenging as expected.",
  },
  {
    name: "Nithish ..",
    ...
    <div className="tp-course-details-2-review-reply-wrap">
        ...
        <div className="tp-course-details-2-review-item-reply" key={index}>
          <div className="tp-course-details-2-review-top d-flex">
            ...
            <div className="tp-course-details-2-review-content">
              <h4>{review.name}</h4>
              <div className="tp-course-details-2-review-star frates">
                {[...Array(5)].map((_, starIndex) => (
                  <span key={starIndex}>
                    <StarTwo
                      clr={starIndex < review.rating ? "#FFC107" : "#BFC5CA"}
                    />
                  </span>
                ))}
      ...
      {visibleReviews < reviewsData.length && (
        <div className="tp-course-details-2-review-reply-btn">
          <a className="pointer" onClick={showMoreReviews}>
            Show More Reviews
          </a>
        </div>
      )}
