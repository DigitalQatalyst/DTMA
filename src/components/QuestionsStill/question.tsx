        ...
        <div className="contact-wrapper">
            ...
            <div className="skills-section">
                <div className="item-1">
                    <h3 className="skills-title">Ready to take your digital skills to the next level?</h3>
                    <p className="skills-description">
                        Explore our AI-powered, role-specific courses designed to help you learn flexibly, upskill efficiently, <br /> and lead digital transformation in your organization.
                    </p>
                </div>
                <div>
